                    ...
                    Container(
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          height: 80,
                          child: Center(
                            child: Text("완료",style: TextStyle(fontSize: 20,color: kWhiteIvoryColor,fontWeight: FontWeight.w600)),
                          ),
                        ),
                      ),
                    )
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          height: 80,
                          child: Center(
                            child: Text("다음",style: TextStyle(fontSize: 20,color: kWhiteIvoryColor,fontWeight: FontWeight.w600)),
                          ),
                        ),
                      ),
                    ),
